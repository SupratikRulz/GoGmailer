 ...
 */
public class Supratik extends javax.swing.JFrame {

    /**
     * Creates new form Supratik
     */
    private int xx,yy;
    public Supratik() {
        initComponents();
        this.setIconImage(new ImageIcon(getClass().getResource("LOGO.PNG")).getImage());
        this.setTitle("Go-Gmailer:Supratik Basu");
    }
    ...
    private void initComponents() {
        ...
        setTitle("Go Gmailer: Supratik Basu");
        ...
        lblYoutube.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                lblYoutubeMouseReleased(evt);
            }
        });
        getContentPane().add(lblYoutube);
        lblYoutube.setBounds(340, 340, 30, 30);

        lblBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/developer/SUPRATIK.PNG"))); // NOI18N
    ...
    private void lblYoutubeMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblYoutubeMouseReleased
        // TODO add your handling code here:
        Browser.main(null, "https://www.youtube.com/channel/UCD_VZUJZcBLHpSUGUSyShLA/videos");
    }//GEN-LAST:event_lblYoutubeMouseReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Supratik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
